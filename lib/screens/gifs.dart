  ...
  Future<Map> _getGifs() async {
    ...
    if (_search == null)
      response = await http.get(
          "https://api.giphy.com/v1/gifs/trending?api_key=Y7ALMGOU5SvfFmAQZOyAvRUPkTvyEdQE&limit=20&rating=G");
    else
      response = await http.get(
          "https://api.giphy.com/v1/gifs/search?api_key=Y7ALMGOU5SvfFmAQZOyAvRUPkTvyEdQE&q=$_search&limit=19&offset=$_offset&rating=G&lang=pt");
